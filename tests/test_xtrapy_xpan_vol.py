...
def test_extrapmodel_vol(fixture):
    ...
    xem_ig =  xpan_vol_ig.factory_extrapmodel(order=1, volume=volume,
                                              uv=fixture.u,
                                              xv=fixture.x,
    )

    xem = xpan_vol.factory_extrapmodel(uv=fixture.u, xv=fixture.x, order=1,
                                       dxdqv=fixture.x, volume=volume, ndim=1)
