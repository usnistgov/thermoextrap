...
def test_to_raw_moments(shape, axis, moments, weighted):
    ...
    s = central.StatsAccum.from_vals(x, moments=moments, w=weights, axis=axis)
...
def test_to_central_moments(shape, axis, moments, weighted):
    ...
    s = central.StatsAccum.from_raw(_raw, moments=moments)
...
def test_to_raw_comoments(shape, axis, moments, weighted):
    ...
    s = central.StatsAccumCov.from_vals(x, x1,moments=moments, w=weights, axis=axis)
...
def test_to_central_comoments(shape, axis, moments, weighted):
    ...
    s = central.StatsAccumCov.from_raw(_raw, moments=moments)
